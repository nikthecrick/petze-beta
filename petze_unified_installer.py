...
opencode() {
    ...
    if [ -z "$raw_intent" ]; then
        ...
        if [ ! -f "$_brief_path" ]; then
            ...
            echo -e "\n\033[34m(‾_‾)\033[0m Reading brief and formulating intent..."
...
" "$_brief_path" 2>/dev/null)
        ...
        echo -e "\n\033[34m(‾_‾)\033[0m Formulating intent..."
        _structured=$(_petze_formulate "$raw_intent" "$PWD")
